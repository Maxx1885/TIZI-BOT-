...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  try {
    ...
    const str = `𝗟𝗜𝗡𝗞 𝗔𝗣𝗞 𝗙𝗜𝗩𝗘 𝗡𝗜𝗚𝗛𝗧𝗦 𝗔𝗧 𝗙𝗥𝗘𝗗𝗗𝗬'𝗦 4

• https://www.mediafire.com/file/1sirdnl8s6ipx8t/FNAF-4-v2.0.2-Modilimitado.io.apk/file
...
handler.command = /^(apkfivenightsatfreddy's4|apkfnaf4|fnaf4apk)$/i;
handler.exp = 50;
handler.fail = null;
