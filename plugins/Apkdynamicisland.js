...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  try {
    ...
    const str = `𝗔𝗣𝗞 𝗗𝗬𝗡𝗔𝗠𝗜𝗖 𝗜𝗦𝗟𝗔𝗡𝗗

https://www.mediafire.com/file/s1id8cv469280aa/DynamicIslandv1.2.6Patchedbyyouarefinished_src_A2ZAPK.COM.apk/file
...
handler.command = /^(Apkdynamicisland|apkdynamicisland|dynamicislandapk)$/i;
handler.exp = 50;
handler.fail = null;
