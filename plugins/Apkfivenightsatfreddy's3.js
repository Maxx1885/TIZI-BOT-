...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  try {
    ...
    const str = `𝗟𝗜𝗡𝗞 𝗔𝗣𝗞 𝗙𝗜𝗩𝗘 𝗡𝗜𝗚𝗛𝗧𝗦 𝗔𝗧 𝗙𝗥𝗘𝗗𝗗𝗬'𝗦 3

• https://www.mediafire.com/file/q9hhzoxts443eiw/Five-Nights-at-Freddy%2527s_3-2.0.1.apks/file
...
handler.command = /^(apkfivenightsatfreddy's3|apkfnaf3|fnaf3apk)$/i;
handler.exp = 50;
handler.fail = null;
