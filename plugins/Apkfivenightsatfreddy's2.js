...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  try {
    ...
    const str = `𝗟𝗜𝗡𝗞 𝗔𝗣𝗞 𝗙𝗜𝗩𝗘 𝗡𝗜𝗚𝗛𝗧𝗦 𝗔𝗧 𝗙𝗥𝗘𝗗𝗗𝗬'𝗦 2

• https://www.mediafire.com/file/vqwyh49nco0gh8q/Five-Nights-at-Freddy%2527s_2-2.0.4.apk/file
...
handler.command = /^(Apkfivenightatfreddy's2|apkfnaf2|apk2fnaf)$/i;
handler.exp = 50;
handler.fail = null;
