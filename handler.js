...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*⚠ 𝑨𝒅𝒗𝒆𝒓𝒕𝒆𝒏𝒄𝒊𝒂*', body: '𝗦𝗮𝗺𝗺𝘆𝗕𝗼𝘁-𝗠𝗗 🧸', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/usxr_angelito/'}}}}, aa);
